...
//                  a customer's home address in a search result. Belt and braces.
...
//
// LINE COMMENTS, NOT A BLOCK COMMENT, and that is not a style choice: the
// wildcard patterns above contain `*/`, which closes a `/** … */` block early
// and turns the rest of the comment into syntax errors. This file did exactly
// that and failed the build.
